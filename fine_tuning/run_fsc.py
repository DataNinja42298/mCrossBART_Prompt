...
from fsc_helpers import (PromptedTextStyleTransferRewardConfig,
...
def main(config: "DictConfig"):
    ...
    (train_dataset, val_dataset, test_dataset) = make_few_shot_classification_dataset(config)
    ...
    prompt_model = make_single_prompt_model(policy_model, config)               # 左 得到prompt
    reward = make_prompted_text_style_transfer_reward(config)                   # 右 得到reward
